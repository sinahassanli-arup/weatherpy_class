...
# Load the _bom_preparation module directly
bom_prep_path = r'C:\Users\Administrator\Documents\weatherpy_class\weatherpy_legacy\data\_bom_preparation.py'
spec = importlib.util.spec_from_file_location("bom_preparation", bom_prep_path)
bom_preparation = importlib.util.module_from_spec(spec)
spec.loader.exec_module(bom_preparation)
...
def test_legacy_import(station_id, year_start, year_end, time_zone, interval):
    ...
    try:
        ...
        data = bom_preparation._import_bomhistoric(
