"""
Module for preparing NOAA data.
"""
...
def prepare_noaa_data(stationID, yearStart, yearEnd, interval, timeZone):
    """
    Prepare NOAA data.
    ...
    # In a real implementation, this would make API requests to the NOAA server
